...
export function useFetchLogs(schedulerApi: string | undefined, instance: string, token: string | null) {
  return useQuery<string[], Error>({
    ...
    queryFn: async () => {
      const logs = `{"level":"warn","module":"runtime","msg":"8ee6520d9e94 [GIN] 2025/11/10 - 17:18:42"}
...
{"level":"warn","module":"runtime","msg":"8ee6520d9e94 [GIN] 2025/11/10 - 17:18:42"}
{"level":"warn","module":"runtime","msg":"8ee6520d9e94 [GIN] 2025/11/10 - 17:18:42"}
{"level":"warn","module":"runtime","msg":"8ee6520d9e94 [GIN] 2025/11/10 - 17:18:42"}`.split('\n')
      i+=2
      return logs.slice(0, i)
    },

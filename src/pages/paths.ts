export const appDetailsPath = (network: string, appId: string) => `/${network}/dashboard/app/${appId}`
export const appDetailsNewMachinePath = (network: string, appId: string) =>
  `/${network}/dashboard/app/${appId}/new-machine`
...
export const machineDetailsPath = (network: string, provider: string, machineId: string) =>
  `/${network}/dashboard/machine/${provider}/instances/${machineId}`
export const machineDetailsTopUpPath = (network: string, provider: string, machineId: string) =>
  `/${network}/dashboard/machine/${provider}/instances/${machineId}/top-up`

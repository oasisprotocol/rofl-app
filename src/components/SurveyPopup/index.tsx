...
export const SurveyPopup: FC<SurveyPopupProps> = ({ onClose, isVisible }) => {
  ...
  return (
    <div className="fixed bottom-5 right-12.5 z-50">
      <Card className="w-[420px] rounded-xl bg-background border shadow-lg">
        <CardContent className="flex flex-col gap-6">
          <div className="flex justify-between items-start gap-6 w-full">
            <div className="text-primary">
              <img src={OasisLogoBlue} alt="Oasis" />
            </div>
            <button className="opacity-70" onClick={onClose}>
              <X className="h-4 w-4 text-foreground" />
            </button>
          </div>

          <div className="flex flex-col gap-1.5">
            <h2 className="text-[30px] font-bold leading-9 text-card-foreground">Help us improve ROFL 🚀</h2>

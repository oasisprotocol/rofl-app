...
export const AppCard: FC<AppCardProps> = ({ app, network }) => {
    ...
    <Card className="rounded-md">
      <CardHeader className="">
        <div className="flex items-start justify-between">
          <h3 className="text-lg font-semibold text-primary pr-2 break-all">
      ...
      <CardFooter className="flex justify-between only:*:grow">
        ...
        {address && <ViewWithOnlyLogsPermission app={app} network={network} />}

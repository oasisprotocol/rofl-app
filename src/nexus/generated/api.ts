...
export const GetRecentBlocks = (
  network: 'mainnet' | 'testnet',
  options?: SecondParameter<typeof GetRecentBlocksMutator>,
  signal?: AbortSignal,
) => {
...
export const getGetRecentBlocksQueryKey = (network?: 'mainnet' | 'testnet') => {
...
>(
  network: 'mainnet' | 'testnet',
  options?: {
    query?: UseQueryOptions<Awaited<ReturnType<typeof GetRecentBlocks>>, TError, TData>
    request?: SecondParameter<typeof GetRecentBlocksMutator>
  },
) => {
  const { query: queryOptions, request: requestOptions } = options ?? {}
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof GetRecentBlocks>>> = ({ signal }) =>
    GetRecentBlocks(network, requestOptions, signal)
...
export type GetRecentBlocksQueryError = void

/**
 * @summary Returns a list of recent blocks across all layers
 */

export function useGetRecentBlocks<TData = Awaited<ReturnType<typeof GetRecentBlocks>>, TError = void>(
  network: 'mainnet' | 'testnet',
  options?: {
    query?: UseQueryOptions<Awaited<ReturnType<typeof GetRecentBlocks>>, TError, TData>
    request?: SecondParameter<typeof GetRecentBlocksMutator>
...
export const GetRuntimeAccountsAddressDelegations = (
  ...
  options?: SecondParameter<typeof GetRuntimeAccountsAddressDelegationsMutator>,
  signal?: AbortSignal,
) => {
  return GetRuntimeAccountsAddressDelegationsMutator<DelegationList>(
    {
      url: `/${encodeURIComponent(String(network))}/${encodeURIComponent(String(runtime))}/accounts/${encodeURIComponent(String(address))}/delegations`,
      method: 'GET',
      params,
      signal,
    },
...
export const getGetRuntimeAccountsAddressDelegationsQueryKey = (
  network?: 'mainnet' | 'testnet',
  runtime?: Runtime,
  address?: EthOrOasisAddress,
  params?: GetRuntimeAccountsAddressDelegationsParams,
...
export const getGetRuntimeAccountsAddressDelegationsQueryOptions = <
  TData = Awaited<ReturnType<typeof GetRuntimeAccountsAddressDelegations>>,
  TError = void,
>(
  network: 'mainnet' | 'testnet',
  runtime: Runtime,
  ...
  params?: GetRuntimeAccountsAddressDelegationsParams,
  options?: {
    query?: UseQueryOptions<Awaited<ReturnType<typeof GetRuntimeAccountsAddressDelegations>>, TError, TData>
    request?: SecondParameter<typeof GetRuntimeAccountsAddressDelegationsMutator>
  },
) => {
  const { query: queryOptions, request: requestOptions } = options ?? {}
  ...
  const queryKey =
    queryOptions?.queryKey ??
    getGetRuntimeAccountsAddressDelegationsQueryKey(network, runtime, address, params)

  const queryFn: QueryFunction<Awaited<ReturnType<typeof GetRuntimeAccountsAddressDelegations>>> = ({
    signal,
  }) => GetRuntimeAccountsAddressDelegations(network, runtime, address, params, requestOptions, signal)
  ...
  return {
    ...
    enabled: !!(network && runtime && address),
    ...queryOptions,
  } as UseQueryOptions<Awaited<ReturnType<typeof GetRuntimeAccountsAddressDelegations>>, TError, TData> & {
    queryKey: QueryKey
  }
}

export type GetRuntimeAccountsAddressDelegationsQueryResult = NonNullable<
  Awaited<ReturnType<typeof GetRuntimeAccountsAddressDelegations>>
>
export type GetRuntimeAccountsAddressDelegationsQueryError = void

/**
 * @summary Returns a runtime account's delegations.
 */

export function useGetRuntimeAccountsAddressDelegations<
  TData = Awaited<ReturnType<typeof GetRuntimeAccountsAddressDelegations>>,
  TError = void,
>(
  network: 'mainnet' | 'testnet',
  ...
  const queryOptions = getGetRuntimeAccountsAddressDelegationsQueryOptions(
    network,
    runtime,
    address,
    params,
...
export const GetRuntimeAccountsAddressDebondingDelegations = (
  ...
  options?: SecondParameter<typeof GetRuntimeAccountsAddressDebondingDelegationsMutator>,
  signal?: AbortSignal,
) => {
  return GetRuntimeAccountsAddressDebondingDelegationsMutator<DebondingDelegationList>(
    {
      url: `/${encodeURIComponent(String(network))}/${encodeURIComponent(String(runtime))}/accounts/${encodeURIComponent(String(address))}/debonding_delegations`,
      method: 'GET',
      params,
      signal,
    },
...
export const getGetRuntimeAccountsAddressDebondingDelegationsQueryKey = (
  network?: 'mainnet' | 'testnet',
  runtime?: Runtime,
  address?: EthOrOasisAddress,
  params?: GetRuntimeAccountsAddressDebondingDelegationsParams,
  ...
  return [
    `/${network}/${runtime}/accounts/${address}/debonding_delegations`,
    ...(params ? [params] : []),
  ] as const
}

export const getGetRuntimeAccountsAddressDebondingDelegationsQueryOptions = <
  TData = Awaited<ReturnType<typeof GetRuntimeAccountsAddressDebondingDelegations>>,
  TError = void,
>(
  network: 'mainnet' | 'testnet',
  runtime: Runtime,
  ...
  options?: {
    query?: UseQueryOptions<
      Awaited<ReturnType<typeof GetRuntimeAccountsAddressDebondingDelegations>>,
      TError,
      TData
    >
    request?: SecondParameter<typeof GetRuntimeAccountsAddressDebondingDelegationsMutator>
  },
) => {
  const { query: queryOptions, request: requestOptions } = options ?? {}
  ...
  const queryKey =
    queryOptions?.queryKey ??
    getGetRuntimeAccountsAddressDebondingDelegationsQueryKey(network, runtime, address, params)

  const queryFn: QueryFunction<Awaited<ReturnType<typeof GetRuntimeAccountsAddressDebondingDelegations>>> = ({
    signal,
  }) =>
    GetRuntimeAccountsAddressDebondingDelegations(network, runtime, address, params, requestOptions, signal)
...
export type GetRuntimeAccountsAddressDebondingDelegationsQueryResult = NonNullable<
  Awaited<ReturnType<typeof GetRuntimeAccountsAddressDebondingDelegations>>
>
export type GetRuntimeAccountsAddressDebondingDelegationsQueryError = void

/**
 * @summary Returns a runtime account's debonding delegations.
 */

export function useGetRuntimeAccountsAddressDebondingDelegations<
  TData = Awaited<ReturnType<typeof GetRuntimeAccountsAddressDebondingDelegations>>,
  TError = void,
>(
  network: 'mainnet' | 'testnet',
  ...
  const queryOptions = getGetRuntimeAccountsAddressDebondingDelegationsQueryOptions(
    network,
    runtime,
    address,
    params,
...
export const GetStatsTxVolume = (
  ...
  options?: SecondParameter<typeof GetStatsTxVolumeMutator>,
  signal?: AbortSignal,
) => {
  return GetStatsTxVolumeMutator<TxVolumeList>(
    { url: `/${encodeURIComponent(String(network))}/stats/tx_volume`, method: 'GET', params, signal },
    options,
  )
}

export const getGetStatsTxVolumeQueryKey = (
  network?: 'mainnet' | 'testnet',
  params?: GetStatsTxVolumeParams,
) => {
...
export const getGetStatsTxVolumeQueryOptions = <
  TData = Awaited<ReturnType<typeof GetStatsTxVolume>>,
  TError = void,
>(
  network: 'mainnet' | 'testnet',
  params?: GetStatsTxVolumeParams,
  options?: {
    query?: UseQueryOptions<Awaited<ReturnType<typeof GetStatsTxVolume>>, TError, TData>
    request?: SecondParameter<typeof GetStatsTxVolumeMutator>
  },
) => {
  const { query: queryOptions, request: requestOptions } = options ?? {}
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof GetStatsTxVolume>>> = ({ signal }) =>
    GetStatsTxVolume(network, params, requestOptions, signal)

  return { queryKey, queryFn, enabled: !!network, ...queryOptions } as UseQueryOptions<
    Awaited<ReturnType<typeof GetStatsTxVolume>>,
    TError,
    TData
  > & { queryKey: QueryKey }
}
...
export type GetStatsTxVolumeQueryError = void
...
export function useGetStatsTxVolume<TData = Awaited<ReturnType<typeof GetStatsTxVolume>>, TError = void>(
  network: 'mainnet' | 'testnet',
  params?: GetStatsTxVolumeParams,
  options?: {
    query?: UseQueryOptions<Awaited<ReturnType<typeof GetStatsTxVolume>>, TError, TData>
